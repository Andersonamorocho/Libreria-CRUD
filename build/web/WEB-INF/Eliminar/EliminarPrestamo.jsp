        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="container">
                        <div class="row">
                            <form action="<%=request.getContextPath()%>/eliminar/prestamo" method="post" class="form-horizontal" role="form">
                                <div class="form-group">
                                    <label for="id" class="col-sm-2 control-label">Id del prestamo</label>
                                    <div class="col-sm-10">
