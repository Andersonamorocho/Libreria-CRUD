...
<%
    Prestamo cuenta = (Prestamo) request.getAttribute("cuenta");
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><%=cuenta.getIdlibro()%></td>
                            </tr>
                        </tbody>
                    </table>
                     <a class="btn btn-default" href="<%=request.getContextPath()%>/formulario/prestamo" role="button">Volver</a>
                </div>
            </div>
        </div>
